...
const FeedBack = () => {
  ...
  return (
    <section className="pt-16 font-nunito">
      <div className="bg-[url('../assets/images/hero4.png')] bg-cover bg-center bg-no-repeat w-full h-auto border-t-4 border-b-4 border-purple-500 shadow-md shadow-purple-500/50">
